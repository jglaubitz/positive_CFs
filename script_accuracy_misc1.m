...
weightFun = 'C2k'; % weight function (1, C2k, sqrt)
...
grid on
str = sprintf( ['plots/accuracy_misc1_dim',num2str(dim),'_',domain,'_',weightFun,'_',points,'_',subsampling,'.fig'] );
%savefig(str);
str = sprintf( ['plots/accuracy_misc1_dim',num2str(dim),'_',domain,'_',weightFun,'_',points,'_',subsampling,'.eps'] );
%saveas(gcf,str,'epsc') 